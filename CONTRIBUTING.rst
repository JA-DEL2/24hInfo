...
Report bugs at https://github.com/JA-DEL2/24hInfo/issues.
...
24HI25Back could always use more documentation, whether as part of the
official 24HI25Back docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
The best way to send feedback is to file an issue at https://github.com/JA-DEL2/24hInfo/issues.
...
Ready to contribute? Here's how to set up `_24hi25back` for local development.

1. Fork the `_24hi25back` repo on GitHub.
...
3. Install your local copy into a virtualenv. Assuming you have virtualenv installed, this is how you set up your fork for local development::
    ...
    $ python -m virtualenv _24hi25back-venv
    $ source _24hi25back-venv/bin/activate
    $ cd _24hi25back/

   Now you can install `_24hi25back` in develop mode in your virtual environment::
...
5. When you're done making changes, check that your changes pass all linting checks and the
   tests, including testing other Python versions with tox::
    ...
    $ make mypy
    $ make bandit
    $ ./docker-compose.sh build test__24hi25back
    $ ./docker-compose.sh run --rm test__24hi25back
...
6. Run the API service locally via `docker-compose`_ to check your changes::
    ...
    $ ./docker-compose.sh build _24hi25back
    $ ./docker-compose.sh run --service-ports --rm _24hi25back
