...
NAME = '_24hi25back'
SHORT_DESCRIPTION = "The fastapi API backend to the "24H de l'info" event 2025."
URL = "https://github.com/JA-DEL2/24hInfo"
AUTHOR = 'Cuisset Mattéo, Jean-Alexis Delcambre, Thibault Lombart, Samuel Tittelein'
EMAIL = 'matteo.cuisset@gmail.com'
...
setup(name=NAME,
      ...
      url=URL,
      packages=find_packages(include=["_24hi25back*"],
