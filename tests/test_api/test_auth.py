...
from _24hi25back.app.utils.security import create_access_token
...
@mock.patch("_24hi25back.app.api.auth.create_access_token",
...
@mock.patch("_24hi25back.app.api.auth.store_user",
