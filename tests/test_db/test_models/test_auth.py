...
from _24hi25back.app.schemas.auth import AuthUserPublic
...
@mock.patch("_24hi25back.app.db.models.auth.pwd_context.hash",
...
@mock.patch("_24hi25back.app.db.models.auth.AuthUser.get_password_hash",
            return_value="dummy")
