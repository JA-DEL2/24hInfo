...
from _24hi25back.app.utils.security import (
...
@pytest.mark.asyncio
@mock.patch("_24hi25back.app.utils.security.jwt.decode",
...
@pytest.mark.asyncio
@mock.patch("_24hi25back.app.utils.security.AuthUser.get_user")
...
@mock.patch("_24hi25back.app.utils.security.datetime")
@mock.patch("_24hi25back.app.utils.security.settings")
